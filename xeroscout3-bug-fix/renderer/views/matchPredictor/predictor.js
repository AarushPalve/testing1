...
import { MatchPredictorConfigDialog } from "./MatchPredictorConfigDialog.js";
import { Chart, registerables } from 'chart.js';
import ChartDataLabels from 'chartjs-plugin-datalabels';
// Register Chart.js components  
Chart.register(...registerables, ChartDataLabels);
export class XeroPredictorView extends XeroView {
    constructor(app) {
    ...
    editConfig(index) {
        ...
        this.dialog_ = new MatchPredictorConfigDialog(configCopy, this.datasets_, this.teamflds_, this.matchflds_, this.formulas_, false);
    ...
    addNewConfig() {
        ...
        this.dialog_ = new MatchPredictorConfigDialog(newConfig, this.datasets_, this.teamflds_, this.matchflds_, this.formulas_, true);
        this.dialog_.on('closed', this.configDialogClosed.bind(this));
        this.dialog_.showCentered(this.elem.parentElement);
    }
    deleteConfig(index) {
