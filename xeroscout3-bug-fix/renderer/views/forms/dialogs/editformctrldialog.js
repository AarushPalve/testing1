...
export class EditFormControlDialog extends XeroDialog {
    constructor(title, formctr) {
        super(title);
    ...
    deleteButton(event) {
        var _a, _b;
        let tag = ((_b = (_a = this.formctrl_) === null || _a === void 0 ? void 0 : _a.item) === null || _b === void 0 ? void 0 : _b.tag) || '';
    ...
    static colorNameToHex(color) {
        ...
        if (Object.hasOwnProperty.call(colorsMap, color)) {
            color = EditFormControlDialog.getProperty(colorsMap, color);
        }
        return color;
    }
    deduceDataType(data) {
...
//# sourceMappingURL=editformctrldialog.js.map