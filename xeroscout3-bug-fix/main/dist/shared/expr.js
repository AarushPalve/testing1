...
exports.Expr = exports.ExprOperator = exports.ExprFunction = exports.ExprFunctionDef = exports.ExprVariable = exports.ExprValue = exports.ExprNode = void 0;
const datavalue_js_1 = require("./datavalue.js");
class ExprNode {
}
exports.ExprNode = ExprNode;
class ExprValue extends ExprNode {
    constructor(value) {
        super();
        this.value = value;
        this.value_ = value;
    ...
    toString() {
        return datavalue_js_1.DataValue.toDisplayString(this.value_);
    }
}
exports.ExprValue = ExprValue;
class ExprVariable extends ExprNode {
    constructor(name) {
        super();
        this.name_ = name;
    }
...
exports.ExprVariable = ExprVariable;
class ExprFunctionDef {
...
exports.ExprFunctionDef = ExprFunctionDef;
class ExprFunction extends ExprNode {
...
class ExprOperator extends ExprNode {
    constructor(which) {
        super();
        this.which_ = which;
    }
    ...
    operPlus(a, b) {
        ...
        if (datavalue_js_1.DataValue.isString(a) &&
            datavalue_js_1.DataValue.isString(b)) {
            ret = {
                type: "string",
                value: a.value + b.value,
            };
        }
        else if (datavalue_js_1.DataValue.isInteger(a) &&
            datavalue_js_1.DataValue.isInteger(b)) {
            ret = {
                type: "integer",
                value: a.value + b.value,
            };
        }
        else if (datavalue_js_1.DataValue.isNumber(a) &&
            datavalue_js_1.DataValue.isNumber(b)) {
            ret = {
                type: "real",
                value: a.value + b.value,
            };
    ...
    operMinus(a, b) {
        ...
        if (datavalue_js_1.DataValue.isInteger(a) &&
            datavalue_js_1.DataValue.isInteger(b)) {
            ret = {
                type: "integer",
                value: a.value - b.value,
    ...
    operEqual(a, b) {
        ...
        if (datavalue_js_1.DataValue.isString(a) && datavalue_js_1.DataValue.isString(b)) {
            ret = {
                type: "boolean",
                value: a.value === b.value,
            };
        }
        else if (datavalue_js_1.DataValue.isNumber(a) && datavalue_js_1.DataValue.isNumber(b)) {
            ret = {
                type: "boolean",
                value: a.value === b.value,
            };
        }
        else if (datavalue_js_1.DataValue.isBoolean(a) && datavalue_js_1.DataValue.isBoolean(b)) {
            ret = {
                type: "boolean",
                value: a.value === b.value,
            };
    ...
    operAnd(a, b) {
        ...
        if (datavalue_js_1.DataValue.isBoolean(a) &&
            datavalue_js_1.DataValue.isBoolean(b)) {
            ret = {
                type: "boolean",
                value: a.value && b.value,
            };
...
class Expr {
    ...
    static initFunctions() {
        Expr.registerFunction("int", 1, (args) => {
            ...
            if (datavalue_js_1.DataValue.isInteger(args[0])) {
                ret = args[0];
            }
            else if (datavalue_js_1.DataValue.isReal(args[0])) {
        ...
        Expr.registerFunction("abs", 1, (args) => {
            ...
            else if (datavalue_js_1.DataValue.isInteger(args[0])) {
                ret = {
                    type: "integer",
        ...
        Expr.registerFunction("average", -1, (args) => {
            ...
            for (let i = 0; i < result.length; i++) {
                if (datavalue_js_1.DataValue.isError(result[i])) {
                    return result[i];
                }
                else if (datavalue_js_1.DataValue.isNull(result[i])) {
                    continue;
                }
                else if (!datavalue_js_1.DataValue.isNumber(result[i])) {
                    return {
                        type: "error",
